...
class FragProfitReport extends StatelessWidget {
        ...
        children: [
          ...
          Obx(() => Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<ProfitReportType>(
                ...
                items: ProfitReportType.values.map((t) => DropdownMenuItem(
                  value: t,
                  child: Row(
  ...
  Widget _buildFilterBar(BuildContext context, ControllerProfitReport controller) {
    return Padding(
